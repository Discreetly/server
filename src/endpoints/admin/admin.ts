...
router.get('/rooms', adminAuth, (req, res) => {
  ...
  prisma.rooms
    .findMany()
    .then((rooms) => {
      // TODO! This should just return the room Ids, and *maybe* the names of the rooms and number of identities
...
// TODO! This shouldn't be under the admin endpoints, it should be under identity
/**
